...
// The I in IStack is used in order to follow a common convention in TS to refer to interfaces and differentiate them from classes
interface IStack<T> { 
...
/* My implementation of the Typed Stack 
